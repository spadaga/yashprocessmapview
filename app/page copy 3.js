  ...
  return (
    <>
      ...
      <main className="flex flex-col items-start justify-start min-h-screen bg-white overflow-auto p-4">
        ...
        <div className="flex gap-2 mb-4 sticky top-0 z-10 bg-white p-2 border-b w-full">
          <button
            className="bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded"
            onClick={() => window.graph?.zoomIn()}
          >
            Zoom In
          </button>
          <button
            className="bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded"
            onClick={() => window.graph?.zoomOut()}
          >
            Zoom Out
          </button>
          <button
        ...
        <div
          ref={containerRef}
          style={{ overflow: 'auto', width: '100%', height: 'calc(100vh - 160px)' }}
